...
class TestRetroStar(BaseAlgorithmTest):
    ...
    def test_by_hand_step1(
        ...
        assert math.isclose(
            output_graph.root_node.data["retro_star_proven_reaction_number"], math.inf
        )
    ...
    def test_by_hand_step3(
        ...
        assert math.isclose(output_graph.root_node.data["retro_star_proven_reaction_number"], 2.6)
    ...
    def test_by_hand_step5(
        ...
        assert math.isclose(output_graph.root_node.data["retro_star_proven_reaction_number"], 1.6)
